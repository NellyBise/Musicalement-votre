...
export default function Presentation() {
  return (
    <section className="flex flex-col items-center mt-24 mx-auto max-w-[1440px] px-8">
      ...
      <iframe
        className="w-full h-96 md:mb-12 md:w-[800px] md:h-[450px]"
      ...
      <div className="flex flex-col text-main-color my-7 md:mb-16 gap-4 max-w-[1440px]">
        <p className="">
