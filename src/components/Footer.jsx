export default function Footer() {
  return (
    <footer className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-12 bg-main-color h-full p-4 text-lg lg:text-xl text-white z-10 relative">
