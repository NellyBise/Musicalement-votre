export default function Footer() {
  return (
    <footer className="flex justify-center items-center gap-12 bg-main-color w-screen h-full p-4 text-xl text-white z-10 relative">
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <span className="text-lg"> ​musicalementvotre66@gmail.com</span>
        </a>
        <a
          href="tel:0613060509"
          className="flex items-center gap-2 hover:text-light-blue duration-500"
        >
          ...
          <span className="text-lg"> 06 13 06 05 09 </span>
        </a>
      </div>
      <div className="flex flex-col gap-2">
        <p className="text-lg">Retrouvez-moi sur les réseaux</p>
